...
\textbf{Note on Q4:} The current matrix does not produce a Q4 outcome. Future refinement with real operational data may identify scenarios warranting an intermediate priority level. A theoretical case: High Confidence + Low Content + Moderate Concern (anxious caller, minor issue).
...
Figure~\ref{fig:ui_high_risk} illustrates the dispatcher interface for a high-priority scenario. The interface presents:
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.85\textwidth]{figures/TRIDENT_high_priority_ui.png}
